...
const ETH_SELL_PRICE = web3.utils.toWei('27', 'Ether') // 200 Dai a.k.a. $200 USD
...
async function sellEth(ethAmount, daiAmount) {
  ...
  const SETTINGS = {
    gasLimit: 2000000, // Override gas settings: https://github.com/ethers-io/ethers.js/issues/469
